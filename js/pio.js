...
var Paul_Pio = function (prop) {
    ...
    var elements = {
        ...
        backtop: modules.create("span", { class: "pio-backtop" }),
    ...
    var action = {
        ...
        touch: function () {
            current.canvas.onclick = function () {
                modules.render(prop.content.touch || ["厚德博学 笃行致远","你在干什么？", "干嘛动我呀！小心我咬你！", "救命！！！", "再摸的话我可要报警了⌇●﹏●⌇", "110 吗，这里有个变态一直在摸我(ó﹏ò)", "不可以这样欺负我啦！"]);
            };
        },
        // 右侧按钮
        buttons: function () {
            ...
            elements.home.onmouseover = function () {
                modules.render(prop.content.home || "有什么问题不懂吗！");
            };
            ...
            elements.skin.onclick = function () {
                ...
                prop.content.skin && prop.content.skin[1] ? modules.render(prop.content.skin[1]) : modules.render("这个模型怎么样~");
            };
            ...
            elements.info.onclick = function () {
                window.open("http://localhost:3004/post/WKImP8YoKJQVvDe");
            };
            ...
            elements.sentence.onmouseover = function () {
                modules.render("我从张三那里听到了不少人生经验。");
            };
            current.menu.appendChild(elements.sentence);

            //回到顶部
            elements.backtop.onclick = function () {
                scrollToTop();
            };
            elements.backtop.onmouseover = function (){
                modules.render("回到顶部！");
            };
            current.menu.appendChild(elements.backtop);
            ...
            elements.close.onmouseover = function () {
                modules.render(prop.content.close || "下次再见吧~");
            };
